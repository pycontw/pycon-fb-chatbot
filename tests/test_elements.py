...
class TestElements:
    ...
    def test_dynamic_text_with_quick_replies(self):
        ...
        res = elements.DynamicText(
            "Hi, {{first_name}}!", "Hello friend!", quick_replies=qrs
        )
        expected = {
            "dynamic_text": {
                "text": "Hi, {{first_name}}!",
    ...
    def test_element(self):
        ...
        expected = {
            ...
            "image_url": "http://facebook.com/image.jpg",
            "subtitle": "Subtitle",
            "default_action": {"type": "web_url", "url": "https://facebook.com"},
            "buttons": [
    ...
    def test_default_action_validation(self):
        defaults = [
            (
                elements.Button(
                    button_type="web_url", url="https://facebook.com", title="Facebook"
                ),
    ...
    def test_button_type_validation(self):
        with pytest.raises(ValueError) as err:
            elements.Button(
                button_type="incorrect", title="Button", url="http://facebook.com"
            )
    ...
    def test_adjustment(self):
        ...
        expected = {"name": "discount", "amount": 1}
        assert expected == res.to_dict()

    def test_address(self):
        res = elements.Address(
            street_1="street_1",
            street_2="street_2",
            city="city",
    ...
    def test_summary(self):
        res = elements.Summary(
            subtotal="10", shipping_cost="5", total_tax="17.5", total_cost="100"
        )
        expected = {
            "subtotal": "10",
            "shipping_cost": "5",
